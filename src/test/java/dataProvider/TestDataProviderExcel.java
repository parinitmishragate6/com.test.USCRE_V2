...
public class TestDataProviderExcel {
	...
	public TestDataProviderExcel(String testDataFilePath, int sheetIndex) throws IOException {
		...
		if (testDataFilePath.endsWith("xlsx")) {
			...
			testDataSheet = testDataWorkbook.getSheetAt(sheetIndex);
	...
	public int getRow() {
		return testDataSheet.getLastRowNum();
	}
	
	// Search key
	
	public String getSearchKey(String testCaseName)
	{
		return getData(testCaseName, "SearchKey");
	}	
